...
import { Button, Card, EmptyState, Field, Input, Modal, Pagination, Spinner, Toggle, useToast } from '../ui/components';
...
export function ClientsPage() {
  ...
  const params = useMemo(
    () => Object.fromEntries(Object.entries({ page, pageSize: 15, search }).filter(([, value]) => value !== '' && value !== undefined)),
    [page, search],
  );
    ...
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-mute">Catalogo general visible para todos los usuarios.</p>
        </div>
