ALTER TABLE `inventory_entries`
  ...
  ADD INDEX `inventory_entries_status_idx`(`status`),
  ADD INDEX `inventory_entries_voided_by_user_id_idx`(`voided_by_user_id`),
  ADD CONSTRAINT `inventory_entries_voided_by_user_id_fkey`
